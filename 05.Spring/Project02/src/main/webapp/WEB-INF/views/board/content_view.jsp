  ...
  <body>
	...
	<table class="table" >
	  ...
	  <tbody>
		...
		<tr>
			<td colspan="2">
				<a class="btn btn-outline-dark" href="modify_view?bId=${content_view.bId }&bName=${content_view.bName}&kind=modify">수정</a>&nbsp;&nbsp;
				<a class="btn btn-outline-dark" href="list?page=<%=session.getAttribute("cpage")%>&bCategory=<%=session.getAttribute("bCategory")%>">목록보기</a>&nbsp;&nbsp;
				<a class="btn btn-outline-dark" href="delete?bId=${content_view.bId}&bName=${content_view.bName}">삭제</a>&nbsp;&nbsp;
				<a class="btn btn-outline-dark" href="reply_view?bId=${content_view.bId }">답변</a>
		</tr>
	  </tbody>
	</table>
