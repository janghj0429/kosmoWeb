	  ...
	  <tbody>
	    ...
	    <tr>
			...
			<td>
				...
				<a href="content_view?bId=${dto.bId}&bCategory=<%=session.getAttribute("bCategory")%>&kind=view">${dto.bTitle }</a></td>
			<td>${dto.bDate }</td>
			<td>${dto.bHit }</td>
	    </tr>
	    </c:forEach>
	    ...
	    <tr>
			<td colspan="2" ><a class="btn btn-outline-dark" href="writeForm?bCategory=<%=session.getAttribute("bCategory")%>">글작성</a></td>			
			<td colspan="2" ><a class="btn btn-outline-dark" href="main" float="right">메인</a></td>
	    ...
	    <tr>
			...
			<c:otherwise>
				<a href="list?page=1&bCategory=${page.boardCategory}">[ &lt;&lt; ]</a>
			</c:otherwise>
			</c:choose>
			<!-- 이전 -->
			<c:choose>
			...
			<c:otherwise>
				<a href="list?page=${page.curPage - 1}&bCategory=${page.boardCategory}">[ &lt; ]</a>
			</c:otherwise>
			</c:choose>
			...
			<c:forEach var="fEach" begin="${page.startPage}" end="${page.endPage}" step="1">
				...
				<c:otherwise>
					<a href="list?page=${fEach}&bCategory=${page.boardCategory}">[ ${fEach} ]</a>&nbsp;
				</c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<c:otherwise>
				<a href="list?page=${page.totalPage}&bCategory=${page.boardCategory}">[&gt;&gt;]</a>
			</c:otherwise>
			</c:choose>
			</td>
		</tr>
