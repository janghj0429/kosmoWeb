  ...
  <body>
	...
	<table class="table" >
	  ...
	  <tbody>
		...
		<td>첨부파일</td>
		<td>
			<a href="download?fileName=${filecontent_view.fileName}&orgfileName=${filecontent_view.orgfileName}">${filecontent_view.fileName }</a>
		</td>
		</tr>
		<tr>
			<td colspan="2">		
				<a class="btn btn-outline-dark"href="filelist?page=<%=session.getAttribute("cpage")%>">목록보기</a>&nbsp;&nbsp;
				<a class="btn btn-outline-dark"href="filedelete?fId=${filecontent_view.fId}&fName=${filecontent_view.fName}">삭제</a>&nbsp;&nbsp;
			</td>		
		</tr>
	  </tbody>
	</table>
