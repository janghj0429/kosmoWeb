  ...
  <body>
	...
	<table class="table">
	  ...
	  <tbody>
	    ...
	    <tr>
			<td colspan="2" ><a class="btn btn-outline-dark" href="write_view.do?bCategory=<%=session.getAttribute("bCategory")%>">글작성</a></td>			
			<td colspan="2" ><a class="btn btn-outline-dark" href="main.jsp" float="right">메인</a></td>
