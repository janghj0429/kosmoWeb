  ...
  <body>
	...
	<table class="table" >
	  ...
	  <tbody>
		...
		<tr>
			<td colspan="2">
				<a class="btn btn-outline-dark" href="nctmodify_view.do?bId=${content_view.bId }&bName=${content_view.bName}&kind=modify">수정</a>&nbsp;&nbsp;
				<a class="btn btn-outline-dark" href="search.do?page=<%=session.getAttribute("cpage")%>%>">목록보기</a>&nbsp;&nbsp;
				<a class="btn btn-outline-dark" href="nctdel.do?bId=${content_view.bId}&bName=${content_view.bName}&column=<%=session.getAttribute("column")%>&word=<%=session.getAttribute("word")%>">삭제</a>&nbsp;&nbsp;
				<a class="btn btn-outline-dark" href="nctreply_view.do?bId=${content_view.bId }">답변</a>
		</tr>
	  </tbody>
	</table>
